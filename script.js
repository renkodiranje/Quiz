pitanje1 = {
    tekst: " Kako se zove stari trgovački deo grada Sarajeva koji je nastao u periodu osmanske vladavine u Bosni I Hercegovini?" ,
...
niz_pitanja = [pitanje1, pitanje2, pitanje3, pitanje4, pitanje5, pitanje6, pitanje7, pitanje8, pitanje9, pitanje10];
        ...
        posalji.addEventListener("click", () => {
            ...
            if(radio.checked == true) {
                ...
                if(radio.value == niz_pitanja[i].indeks_korektnog_odgovora) {
                    ...
                    par.innerHTML += `<p style="color:green;">Tačno ste odgovorili na ${i+1}. pitanje<p>`;
